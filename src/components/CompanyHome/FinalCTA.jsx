    ...
    <footer className="fn-footer">
      ...
      <section className="fn-cta">
        ...
        >
          ...
          <button className="fn-btn-primary" onClick={() => go("#contact")}>
        ...
        <div className="fn-footer__main">
          ...
          <div className="fn-footer__columns">
            <div className="fn-col">
              ...
              <button type="button" onClick={() => go("#process")}>Architecture</button>
              <button type="button" onClick={() => go("#contact")}>Start Project</button>
            </div>
