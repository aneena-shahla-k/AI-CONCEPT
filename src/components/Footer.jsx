      ...
      <section className="fn-cta">
        ...
        >
          ...
          <h2 className="fn-cta__title">
            Have An Idea?
            <br />
            <span className="fn-cta__title-accent">Let's Make It Real.</span>
          </h2>

          {/* DESCRIPTION */}
          <p className="fn-cta__lead">
            From strategy to technology, we build digital systems that turn
          ...
          <div className="fn-cta-route">
            ...
            <span className="fn-route-dash">─────────</span>
            <Globe2 size={13} />
      ...
      <div className="fn-footer__container">
        <div className="fn-footer__main">
          ...
          <div className="fn-footer__brand">
            ...
            >
              <span className="fn-brand-main">AI CONCEPT</span>
              <span className="fn-logo-sub">LLC</span>
            </button>
          ...
          <div className="fn-footer__columns">
            ...
            <div className="fn-col">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive ? "fn-footer-link active" : "fn-footer-link"
                }
              >
                <span>Home</span>
            ...
            {/* CAPABILITIES (CONNECTED TO SOLUTIONS EXPLORER) */}
            <div className="fn-col">
              <span className="fn-col-label">CAPABILITIES</span>

              <button
                type="button"
                onClick={() => goToPage("/solutions?tab=website-development")}
              >
                Web Platforms
              </button>
              ...
              <button
                type="button"
                onClick={() => goToPage("/solutions?tab=app-development")}
              >
                Mobile Applications
              </button>
              ...
              <button
                type="button"
                onClick={() => goToPage("/solutions?tab=e-commerce")}
              >
                E-Commerce Systems
              </button>
              ...
              <button
                type="button"
                onClick={() => goToPage("/solutions?tab=booking-platforms")}
              >
                Booking Engines
              </button>
              ...
              <button
                type="button"
                onClick={() => goToPage("/solutions?tab=ai-solutions")}
              >
                AI & Automation
              </button>
              ...
              <button
                type="button"
                onClick={() => goToPage("/solutions?tab=erp-solutions")}
              >
                ERP Business Core
              </button>
            </div>
        ...
        <div className="fn-footer__bottom">
          <span className="fn-copy">
            © {new Date().getFullYear()} AI CONCEPT LLC. ALL RIGHTS RESERVED.
          </span>

          <span className="fn-bottom-tag">BUILDING DIGITAL EXPERIENCES</span>

          <button type="button" className="fn-top-btn" onClick={backToTop}>
